 ...
 *
 * Created by You on January 27, 2014.
 *
...
task ("help", function()
{
    ...
    colorPrint("TinyMCEView - Framework", "bold+green");
    colorPrint("--------------------------------------------------------------------------", "bold+green");
