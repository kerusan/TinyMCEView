...
tinymce.PluginManager.add('image', function(editor) {
	...
	function showDialog(imageList) {
		...
		function updateStyle() {
			...
			delete css.margin;
			css['margin-top'] = css['margin-bottom'] = addPixelSuffix(data.vspace||"0");
			css['margin-left'] = css['margin-right'] = addPixelSuffix(data.hspace||"0");
			css['border-width'] = addPixelSuffix(data.border||"0");
